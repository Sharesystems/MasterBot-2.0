...
// Login //
console.log("Welcome to MasterBot!")
console.log("")
//var username = readline.question("Username: "); 
//var passwort = readline.question("Passwort: ");
//
//let username1 = fs.readFileSync("./api/product/users.txt", "utf8");
//let passwort1 = fs.readFileSync("./api/product/passwort.txt", "utf8");
//
...
fetch.default(`https://sharesystems.github.io/MasterBot-2.0/`)
    .then(res => res.json())
    .then(data => {
